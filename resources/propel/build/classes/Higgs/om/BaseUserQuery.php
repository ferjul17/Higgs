 ...
 * @method UserQuery orderByAuthorId($order = Criteria::ASC) Order by the author_id column
 ...
 * @method UserQuery groupByAuthorId() Group by the author_id column
 ...
 * @method User findOneByAuthorId(int $author_id) Return the first User filtered by the author_id column
 ...
 * @method array findByAuthorId(int $author_id) Return User objects filtered by the author_id column
...
abstract class BaseUserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'Higgs', $modelName = 'User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `ID`, `USERNAME`, `PASSWORD`, `EMAIL`, `AUTHOR_ID`, `CREATED_AT` FROM `user` WHERE `ID` = :p0';
        try {
    ...
    public function filterByAuthorId($authorId = null, $comparison = null)
    {
        if (is_array($authorId)) {
            ...
            if (isset($authorId['min'])) {
                $this->addUsingAlias(UserPeer::AUTHOR_ID, $authorId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($authorId['max'])) {
                $this->addUsingAlias(UserPeer::AUTHOR_ID, $authorId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserPeer::AUTHOR_ID, $authorId, $comparison);
    }
    ...
    public function filterByPost($post, $comparison = null)
    {
        if ($post instanceof Post) {
            return $this
                ->addUsingAlias(UserPeer::ID, $post->getEditorId(), $comparison);
        } elseif ($post instanceof PropelObjectCollection) {
            return $this
                ->usePostQuery()
                ->filterByPrimaryKeys($post->getPrimaryKeys())
     ...
     * @throws   PropelException - if the provided filter is invalid.
     */
    public function filterByPost($subject, $comparison = null)
    {
        if ($subject instanceof Subject) {
            return $this
                ->addUsingAlias(UserPeer::ID, $subject->getUserId(), $comparison);
            ...
            throw new PropelException('filterByPost() only accepts arguments of type Subject or PropelCollection');
        }
    }
    ...
    /**
     * Use the Post relation Subject object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
    ...
    public function usePostQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPost($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Post', 'SubjectQuery');
    }
