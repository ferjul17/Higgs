...
abstract class BaseSubject extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Higgs\\Model\\SubjectPeer';
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = SubjectPeer::TITLE;
        }
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[] = SubjectPeer::CATEGORY_ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = SubjectPeer::USER_ID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SubjectPeer::CATEGORY_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SubjectPeer::CATEGORY_ID)) $criteria->add(SubjectPeer::CATEGORY_ID, $this->category_id);
    ...
    public function getCategory(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCategory === null && ($this->category_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCategory->addSubjects($this);
             */
        }
     ...
     * @return PropelObjectCollection|Post[] List of Post objects
     */
    public function getPostsJoinEditor($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PostQuery::create(null, $criteria);
        $query->joinWith('Editor', $join_behavior);
