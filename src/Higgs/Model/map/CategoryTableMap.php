...
class CategoryTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Higgs\\Model\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Higgs.Model.Category';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CategoryTableMap::ID, CategoryTableMap::TITLE, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'TITLE', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CategoryTableMap::ID => 0, CategoryTableMap::TITLE => 1, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'TITLE' => 1, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryTableMap::TITLE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Higgs\Model\Category) { // it's a model object
