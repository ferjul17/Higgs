...
class RoleTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Higgs\\Model\\Role';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Higgs.Model.Role';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(RoleTableMap::ID, RoleTableMap::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(RoleTableMap::ID => 0, RoleTableMap::NAME => 1, ),
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Higgs\Model\Role) { // it's a model object
