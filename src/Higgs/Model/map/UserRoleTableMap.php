...
class UserRoleTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Higgs\\Model\\UserRole';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Higgs.Model.UserRole';
     ...
     * and findPk*() calls.
     *
     * @param \Higgs\Model\UserRole $obj A \Higgs\Model\UserRole object.
     ...
     *
     * @param mixed $value A \Higgs\Model\UserRole object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Higgs\Model\UserRole) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Higgs\Model\UserRole object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Higgs\Model\UserRole) { // it's a model object
