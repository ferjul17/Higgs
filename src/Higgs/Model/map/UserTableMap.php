...
class UserTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Higgs\\Model\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Higgs.Model.User';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Username', 'Password', 'Salt', 'Email', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'username', 'password', 'salt', 'email', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(UserTableMap::ID, UserTableMap::USERNAME, UserTableMap::PASSWORD, UserTableMap::SALT, UserTableMap::EMAIL, UserTableMap::CREATED_AT, UserTableMap::UPDATED_AT, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'USERNAME', 'PASSWORD', 'SALT', 'EMAIL', 'CREATED_AT', 'UPDATED_AT', ),
        self::TYPE_FIELDNAME     => array('id', 'username', 'password', 'salt', 'email', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Username' => 1, 'Password' => 2, 'Salt' => 3, 'Email' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'username' => 1, 'password' => 2, 'salt' => 3, 'email' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(UserTableMap::ID => 0, UserTableMap::USERNAME => 1, UserTableMap::PASSWORD => 2, UserTableMap::SALT => 3, UserTableMap::EMAIL => 4, UserTableMap::CREATED_AT => 5, UserTableMap::UPDATED_AT => 6, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'SALT' => 3, 'EMAIL' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'username' => 1, 'password' => 2, 'salt' => 3, 'email' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::SALT);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Higgs\Model\User) { // it's a model object
