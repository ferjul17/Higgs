...
use Higgs\Model\Map\RoleTableMap;
...
abstract class RoleQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Higgs\Model\Base\RoleQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'Higgs', $modelName = '\\Higgs\\Model\\Role', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Higgs\Model\RoleQuery) {
            return $criteria;
        }
        $query = new \Higgs\Model\RoleQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filter the query by a related \Higgs\Model\UserRole object
     *
     * @param \Higgs\Model\UserRole|ObjectCollection $userRole  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildRoleQuery The current query, for fluid interface
     */
    ...
    {
        if ($userRole instanceof \Higgs\Model\UserRole) {
            return $this
            ...
            throw new PropelException('filterByUserRole() only accepts arguments of type \Higgs\Model\UserRole or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Higgs\Model\UserRoleQuery A secondary query class using the current class as primary query
     */
    public function useUserRoleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUserRole($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'UserRole', '\Higgs\Model\UserRoleQuery');
    }
