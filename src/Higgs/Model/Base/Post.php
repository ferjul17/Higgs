...
abstract class Post implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Higgs\\Model\\Map\\PostTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildForum[] Collection to store aggregation of ChildForum objects.
     */
    ...
    /**
     * Initializes internal state of Higgs\Model\Base\Post object.
     */
     ...
     * @return   \Higgs\Model\Post The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PostTableMap::ID] = true;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[PostTableMap::MESSAGE] = true;
        }
    ...
    public function setSubjectId($v)
    {
        ...
        if ($this->subject_id !== $v) {
            $this->subject_id = $v;
            $this->modifiedColumns[PostTableMap::SUBJECT_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[PostTableMap::USER_ID] = true;
        }
    ...
    public function setEditorId($v)
    {
        ...
        if ($this->editor_id !== $v) {
            $this->editor_id = $v;
            $this->modifiedColumns[PostTableMap::EDITOR_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[PostTableMap::CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[PostTableMap::UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PostTableMap::translateFieldName('Message', TableMap::TYPE_PHPNAME, $indexType)];
            $this->message = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PostTableMap::translateFieldName('SubjectId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PostTableMap::translateFieldName('EditorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->editor_id = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PostTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            throw new PropelException("Error populating \Higgs\Model\Post object", 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PostTableMap::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PostTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PostTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PostTableMap::ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PostTableMap::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PostTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(PostTableMap::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'MESSAGE';
        }
        if ($this->isColumnModified(PostTableMap::SUBJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SUBJECT_ID';
        }
        if ($this->isColumnModified(PostTableMap::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USER_ID';
        }
        if ($this->isColumnModified(PostTableMap::EDITOR_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PostTableMap::ID)) $criteria->add(PostTableMap::ID, $this->id);
        if ($this->isColumnModified(PostTableMap::MESSAGE)) $criteria->add(PostTableMap::MESSAGE, $this->message);
        if ($this->isColumnModified(PostTableMap::SUBJECT_ID)) $criteria->add(PostTableMap::SUBJECT_ID, $this->subject_id);
        if ($this->isColumnModified(PostTableMap::USER_ID)) $criteria->add(PostTableMap::USER_ID, $this->user_id);
        if ($this->isColumnModified(PostTableMap::EDITOR_ID)) $criteria->add(PostTableMap::EDITOR_ID, $this->editor_id);
        if ($this->isColumnModified(PostTableMap::CREATED_AT)) $criteria->add(PostTableMap::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PostTableMap::UPDATED_AT)) $criteria->add(PostTableMap::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PostTableMap::DATABASE_NAME);
        $criteria->add(PostTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Higgs\Model\Post (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Higgs\Model\Post Clone of current object.
     * @throws PropelException
     */
     ...
     * @throws PropelException
     */
    public function setEditor(ChildUser $v = null)
    {
        if ($v === null) {
     ...
     * @throws PropelException
     */
    public function getEditor(ConnectionInterface $con = null)
    {
        if ($this->aEditor === null && ($this->editor_id !== null)) {
            $this->aEditor = ChildUserQuery::create()->findPk($this->editor_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
    ...
    public function initForums($overrideExisting = true)
    {
        ...
        $this->collForums = new ObjectCollection();
        $this->collForums->setModel('\Higgs\Model\Forum');
    }

    /**
     * Gets an array of ChildForum objects which contain a foreign key that references this object.
     *
     ...
     * @param      ConnectionInterface $con optional connection object
     * @return Collection|ChildForum[] List of ChildForum objects
     * @throws PropelException
     */
    public function getForums($criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collForums || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collForums) {
                ...
                $collForums = ChildForumQuery::create(null, $criteria)
     ...
     *
     * @param      Collection $forums A Propel collection.
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildPost The current object (for fluent API support)
     */
    public function setForums(Collection $forums, ConnectionInterface $con = null)
    {
        $forumsToDelete = $this->getForums(new Criteria(), $con)->diff($forums);


        $this->forumsScheduledForDeletion = $forumsToDelete;
     ...
     * @throws PropelException
     */
    public function countForums(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collForumsPartial && !$this->isNew();
        if (null === $this->collForums || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collForums) {
            ...
            $query = ChildForumQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildForum object to this object
     * through the ChildForum foreign key attribute.
     *
     * @param    ChildForum $l ChildForum
     * @return   \Higgs\Model\Post The current object (for fluent API support)
     */
    public function addForum(ChildForum $l)
    {
        if ($this->collForums === null) {
            $this->initForums();
            $this->collForumsPartial = true;
     ...
     * @return Collection|ChildForum[] List of ChildForum objects
     */
    public function getForumsJoinCategory($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildForumQuery::create(null, $criteria);
