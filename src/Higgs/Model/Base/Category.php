...
abstract class Category implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Higgs\\Model\\Map\\CategoryTableMap';
    ...
    /**
     * Initializes internal state of Higgs\Model\Base\Category object.
     */
     ...
     * @return   \Higgs\Model\Category The current object (for fluent API support)
     */
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[CategoryTableMap::TITLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Higgs\Model\Category object", 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->forumsScheduledForDeletion !== null) {
                if (!$this->forumsScheduledForDeletion->isEmpty()) {
                    \Higgs\Model\ForumQuery::create()
                        ->filterByPrimaryKeys($this->forumsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::TITLE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::TITLE)) $criteria->add(CategoryTableMap::TITLE, $this->title);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Higgs\Model\Category (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Higgs\Model\Category Clone of current object.
     * @throws PropelException
     */
    ...
    public function removeForum($forum)
    {
        if ($this->getForums()->contains($forum)) {
            ...
            $this->forumsScheduledForDeletion[]= clone $forum;
     ...
     * @return Collection|ChildForum[] List of ChildForum objects
     */
    public function getForumsJoinLastPost($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildForumQuery::create(null, $criteria);
        $query->joinWith('LastPost', $joinBehavior);
