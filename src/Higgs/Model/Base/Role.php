...
abstract class Role implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Higgs\\Model\\Map\\RoleTableMap';
    ...
    /**
     * Initializes internal state of Higgs\Model\Base\Role object.
     */
     ...
     * @return   \Higgs\Model\Role The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[RoleTableMap::ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[RoleTableMap::NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Higgs\Model\Role object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Higgs\Model\Role (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Higgs\Model\Role Clone of current object.
     * @throws PropelException
     */
    ...
    public function initUsers()
    {
        ...
        $this->collUsers->setModel('\Higgs\Model\User');
    }
