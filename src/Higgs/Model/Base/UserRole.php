...
abstract class UserRole implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Higgs\\Model\\Map\\UserRoleTableMap';
    ...
    /**
     * Initializes internal state of Higgs\Model\Base\UserRole object.
     */
     ...
     * @return   \Higgs\Model\UserRole The current object (for fluent API support)
     */
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[UserRoleTableMap::USER_ID] = true;
        }
    ...
    public function setRoleId($v)
    {
        ...
        if ($this->role_id !== $v) {
            $this->role_id = $v;
            $this->modifiedColumns[UserRoleTableMap::ROLE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Higgs\Model\UserRole object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Higgs\Model\UserRole (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Higgs\Model\UserRole Clone of current object.
     * @throws PropelException
     */
