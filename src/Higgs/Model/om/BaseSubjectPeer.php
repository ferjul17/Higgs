...
abstract class BaseSubjectPeer
{
    ...
    /**
     * Selects a collection of Subject objects pre-filled with all related objects except User.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($obj->isNew() || $obj->isColumnModified(SubjectPeer::TITLE))
            $columns[SubjectPeer::TITLE] = $obj->getTitle();
