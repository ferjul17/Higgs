...
abstract class BaseCategory extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Higgs\\Model\\CategoryPeer';
     ...
     * @return PropelObjectCollection|Forum[] List of Forum objects
     */
    public function getForumsJoinLastPost($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ForumQuery::create(null, $criteria);
        $query->joinWith('LastPost', $join_behavior);
